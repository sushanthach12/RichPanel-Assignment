        ...
        <div className="flex mx-auto min-h-full flex-col justify-center items-center py-12">
            <div className="bg-white w-[33%] px-12 py-10 rounded-3xl">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <h2 className="mt-4 text-center text-2xl font-bold leading-9 tracking-tight text-gray-700">Create Account</h2>
                </div>
                ...
                <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-4" action="#" method="POST">
                        <div>
                            ...
                            <div className="mt-1">
                                <input id="name" name="name" type="text" placeholder="name" required className="block w-full rounded-md px-3 py-1.5 text-gray-900 border border-gray-300 outline-none shadow-sm placeholder:text-gray-400 focus-within:border-gray-400 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                        <div>
